    ...
    <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
      ...
      <input type="text" placeholder='Task Description' value={taskDescription} onChange={(e) => setTaskDescription(e.target.value)}/>
        ...
        <div className={styles.priorityOption}>
          <input type="radio" name='priority' value='low' onChange={(e) => setTaskPriority(e.target.value)}/>
          <label htmlFor="priority">Low</label>
        </div>
        <div className={styles.priorityOption}>
          <input type="radio" name='priority' value='medium' onChange={(e) => setTaskPriority(e.target.value)}/>
          <label htmlFor="priority">Medium</label>
        </div>
        <div className={styles.priorityOption}>
          <input type="radio" name='priority' value='high' onChange={(e) => setTaskPriority(e.target.value)}/>
          <label htmlFor="priority">High</label>
        </div>
        <div className={styles.priorityOption}>
          <input type="radio" name='priority' value='critical' onChange={(e) => setTaskPriority(e.target.value)}/>
          <label htmlFor="priority">Critical</label>
        </div>
        <label htmlFor="">Low</label>
        </div>
      <input type="text" placeholder='Tag (optional)' value={taskTag} onChange={(e) => setTaskTag(e.target.value)}/>
      <motion.button 
